    ...
    <section className="bg-white rounded-xl shadow-lg p-6 border border-secondary-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="flex flex-col">
          ...
          >
            <option value="30d">30日プラン (40%割引 / 50%リスクプレミアム料)</option>
            <option value="1y">1年プラン (40%割引 / 33%リスクプレミアム料)</option>
          </select>
          <small className="text-secondary-500 mt-1">プラン期間終了後、Savingsの損失分はコスト還元</small>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-secondary-600">
              対象リソースのサービスに対応する標準RI/SPが１年契約のみの場合、１年プランのスマート予約割引は提供されません。本シミュレーションでは考慮していないため、ご留意ください。
            </p>
          </div>
        </div>
      </div>
